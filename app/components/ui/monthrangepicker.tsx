...
const MONTHS: Month[][] = [
  [
    { number: 0, name: "1", yearOffset: 0 },
    { number: 1, name: "2", yearOffset: 0 },
    { number: 2, name: "3", yearOffset: 0 },
    { number: 3, name: "4", yearOffset: 0 },
    { number: 0, name: "1", yearOffset: 1 },
    { number: 1, name: "2", yearOffset: 1 },
    { number: 2, name: "3", yearOffset: 1 },
    { number: 3, name: "4", yearOffset: 1 },
  ],
  [
    { number: 4, name: "5", yearOffset: 0 },
    { number: 5, name: "6", yearOffset: 0 },
    { number: 6, name: "7", yearOffset: 0 },
    { number: 7, name: "8", yearOffset: 0 },
    { number: 4, name: "5", yearOffset: 1 },
    { number: 5, name: "6", yearOffset: 1 },
    { number: 6, name: "7", yearOffset: 1 },
    { number: 7, name: "8", yearOffset: 1 },
  ],
  [
    { number: 8, name: "9", yearOffset: 0 },
    { number: 9, name: "10", yearOffset: 0 },
    { number: 10, name: "11", yearOffset: 0 },
    { number: 11, name: "12", yearOffset: 0 },
    { number: 8, name: "9", yearOffset: 1 },
    { number: 9, name: "10", yearOffset: 1 },
    { number: 10, name: "11", yearOffset: 1 },
    { number: 11, name: "12", yearOffset: 1 },
  ],
];
              ...
              <Button
                onClick={() => {
                  ...
                  if (onMonthRangeSelect) {
                    onMonthRangeSelect({
                      start: getFirstDayOfMonth(
                        s.startMonth.getFullYear(),
                        s.startMonth.getMonth(),
                      ),
                      end: getLastDayOfMonth(
                        s.endMonth.getFullYear(),
                        s.endMonth.getMonth(),
                      ),
                    });
                  }
